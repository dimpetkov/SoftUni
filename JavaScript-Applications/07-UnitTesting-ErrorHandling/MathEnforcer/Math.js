...
describe("mathEnforcer", function () {
    describe('addFive', function () {
        ...
        it('should return correct result for possitive integer input', () => {
            expect(mathEnforcer.addFive(10)).to.equal(15)
        })
        it('should return undefined for negative integer input', () => {
            expect(mathEnforcer.addFive(-5)).to.equal(0)
        })
        it('should return undefined for floating point param', () => {
    ...
    describe('subtractTen', function () {
        ...
        it('should return correct result for negative input', () => {
            expect(mathEnforcer.subtractTen(-10)).to.equal(-20)
        })
        it('should return correct result for floating point input', () => {
            expect(mathEnforcer.subtractTen(3.14)).to.be.closeTo(-6.85, 0.01)
        })
    });
    describe('sum', function () {
        ...
        it('should return correct result for floating point inputs', () => {
